        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-primary text-black rounded-lg font-medium hover:bg-primary/90 transition-colors"
              >
                Gönder
              </button>
            </form>
              ...
              <div className="grid grid-cols-3 gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className={`flex flex-col items-center gap-2 p-4 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors ${link.color}`}
                  >
                    {link.icon}
